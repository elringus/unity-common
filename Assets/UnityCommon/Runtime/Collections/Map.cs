...
namespace UnityCommon
{
    ...
    [Serializable]
    public abstract class MapImpl<TKey, TValue, TValueStorage> : MapImpl, IDictionary<TKey, TValue>, IDictionary, ISerializationCallbackReceiver, IDeserializationCallback, ISerializable
    {
        ...
        public MapImpl (IEqualityComparer<TKey> comparer)
        {
            m_dict = new Dictionary<TKey, TValue>(comparer);
        }

        public MapImpl (IDictionary<TKey, TValue> dict)
        {
        ...
        protected MapImpl (SerializationInfo info, StreamingContext context)
        {
    ...
    {
        public class Storage<T> : MapImpl.Storage
        {
            public T data;
        }
    }
    ...
    /// </remarks>
    public class Map<TKey, TValue> : MapImpl<TKey, TValue, TValue>
    {
        public Map () { }
        public Map (IEqualityComparer<TKey> comparer) : base(comparer) { }
        public Map (IDictionary<TKey, TValue> dict) : base(dict) { }
    ...
    public class Map<TKey, TValue, TValueStorage> : MapImpl<TKey, TValue, TValueStorage> where TValueStorage : Map.Storage<TValue>, new()
    {
        public Map () { }
        public Map (IEqualityComparer<TKey> comparer) : base(comparer) { }
        public Map (IDictionary<TKey, TValue> dict) : base(dict) { }
